...
export default function CreateItem(props) {
    ...
    const encryptedItemId = CryptoJS.AES.encrypt(JSON.stringify(collectionIdState), process.env.REACT_APP_SECRET_PASS).toString();
    ...
    const [selectedMaterialsState, setselectedMaterialsState] = useState([])
    ...
    const [getItemInfoAPI, resGetItemInfoAPI] = useGetItemDetailedInfoMutation()
    ...
    const generalInfoFromik = useFormik({
        ...
        onSubmit: values => {
            ...
            createItemGeneralAPI({
                ...
                Artworkid: encodeURIComponent(decryptedItemIdBytes),
                PhysicalArt: values.PhysicalArt,
    ...
    const gerneraInfo = () => {
        return (
            <>
                {resGetItemInfoAPI.isLoading ? <>
                    <div>Loading...</div>
                </> : (
                    <form onSubmit={generalInfoFromik.handleSubmit}>
                        <select className="form-select form-select-lg" name="ProductCategory" onChange={generalInfoFromik.handleChange} aria-label=".form-select-lg example">
                            <option ></option>
                            {artProductCategoryState.map((category, index) => {
                                return <option selected={generalInfoFromik?.values?.ProductCategory == category?._id} key={index} value={category?._id}>{category?.Title}</option>
                            })}
                        </select>
                        ...
                        {generalInfoFromik.values.ProductCategory == "2"
                            ...
                            || generalInfoFromik.values.ProductCategory == "6" ? (<>
                                {generalInfoFromik.values.ProductCategory == "2" ? (<>
                                    ...
                                    <select className="form-select form-select-lg" name="ProductName" onChange={generalInfoFromik.handleChange} aria-label=".form-select-lg example">
                                        <option ></option>
                                        {artProdcutFrunishingState.map((name, index) => {
                                            return <option selected={generalInfoFromik?.values?.ProductName == name?._id} key={index} value={name?._id}>{name?.Title}</option>
                                        })}
                                    </select>
                                </>) : null}
                        ...
                        {generalInfoFromik.values.ProductCategory == "2"
                            ...
                            ? (<>
                                {generalInfoFromik.values.ProductCategory == "2" && generalInfoFromik.values?.ProductName === "Cushions" ? (<>
                                    ...
                                    <select className="form-select form-select-lg" name="ProductStyle" onChange={generalInfoFromik.handleChange} aria-label=".form-select-lg example">
                                        <option></option>
                                        {artProdcutStyleState.map((style, index) => {
                                            return <option selected={generalInfoFromik?.values?.ProductStyle == style?._id} key={index} value={style?._id}>{style?.Title}</option>
                                        })}
                                    </select>
                                </>)}
                        ...
                        {generalInfoFromik.values?.ProductName === "Cushions" ? (<>
                            ...
                            <select className="form-select form-select-lg" name="ProductFabric" onChange={generalInfoFromik.handleChange} aria-label=".form-select-lg example">
                                <option></option>
                                {artProdcutFabricState.map((fabric, index) => {
                                    return <option selected={generalInfoFromik?.values?.ProductFabric === fabric?.Title} key={index} value={fabric?.Title}>{fabric?.Title}</option>
                                })}
                            </select>
                        ...
                        {generalInfoFromik.values?.ProductName === "Cushions"
                            ...
                            ? (<>
                                ...
                                <select className="form-select form-select-lg" name="ProductTechnique" onChange={generalInfoFromik.handleChange} aria-label=".form-select-lg example">
                                    <option></option>
                                    {artProdcutTechniqueState.map((technique, index) => {
                                        return <option selected={generalInfoFromik?.values?.ProductTechnique === technique?.Title} key={index} value={technique?.Title}>{technique?.Title}</option>
                                    })}
                                </select>
                        ...
                        {generalInfoFromik.values?.ProductName === "Cushions"
                            ...
                            ? (<>
                                ...
                                <select className="form-select form-select-lg" name="ProductShape" onChange={generalInfoFromik.handleChange} aria-label=".form-select-lg example">
                                    <option></option>
                                    {artProdcutShapeState.map((technique, index) => {
                                        return <option selected={generalInfoFromik?.values?.ProductShape === technique?.Title} key={index} value={technique?.Title}>{technique?.Title}</option>
                                    })}
                                </select>
                        ...
                        {generalInfoFromik.values?.ProductName === "Cushions" ? (<>
                            ...
                            <select className="form-select form-select-lg" name="ProductSize" onChange={generalInfoFromik.handleChange} aria-label=".form-select-lg example">
                                <option></option>
                                {artProdcutCushionSizeState.map((size, index) => {
                                    return <option selected={generalInfoFromik?.values?.ProductSize === size?.Title} key={index} value={size?.Title}>{size?.Title}</option>
                                })}
                            </select>
                        ...
                        {generalInfoFromik.values.ProductCategory == "6" ? (<>
                            ...
                            <select className="form-select form-select-lg" name="ProductMaterial" onChange={generalInfoFromik.handleChange} aria-label=".form-select-lg example">
                                <option></option>
                                {artProdcutMaterialState.map((material, index) => {
                                    return <option selected={generalInfoFromik?.values?.ProductMaterial === material?._id} key={index} value={material?._id}>{material?.Title}</option>
                                })}
                            </select>
                        ...
                        <select className="form-select form-select-lg" name="ProductBrand" onChange={generalInfoFromik.handleChange} aria-label=".form-select-lg example">
                            <option ></option>
                            {artProdcutBrandState.map((brand, index) => {
                                return <option selected={generalInfoFromik?.values?.ProductBrand == brand?._id} key={index} value={brand?._id}>{brand?.Title}</option>
                            })}
                        </select>
            ...
            <form onSubmit={artistDetailsFromik.handleSubmit}>
                ...
                <div className="d-flex justify-content-around">
                    {apiLoading ?
                        ...
                        : <>
                            <button type="button" onClick={() => { setcreateItemState(0) }} className="btn">Back</button>
                            <button type="submit" className="btn btn-primary">Submit</button>
                        </>
                    }
                </div>
            ...
            <form onSubmit={pricingFromik.handleSubmit}>
                ...
                <div className="d-flex justify-content-around">
                    {apiLoading ?
                        ...
                        : <>
                            <button type="button" onClick={() => { setcreateItemState(1) }} className="btn">Back</button>
                            <button type="submit" className="btn btn-primary">Submit</button>
                        </>
                    }
                </div>
            ...
            <form onSubmit={logisticsFromik.handleSubmit}>
                ...
                <div className="d-flex justify-content-around">
                    {apiLoading ?
                        ...
                        : <>
                            <button type="button" onClick={() => { setcreateItemState(2) }} className="btn">Back</button>
                            <button type="submit" className="btn btn-primary">Submit</button>
                        </>
                    }
                </div>
        ...
        onSubmit: values => {
            ...
            createItemImageDetailAPI({
                ...
                if (res.data?.status) {
                    ...
                    showToast(res.data.message)
                    setAPILoading(false)
                    window.location.replace(`/my-collection/${encodeURIComponent(encryptedItemId)}`)
                } else {
                    setAPILoading(false)
                    showErroToast(res.data.message)
                }
    ...
    const updateThumbupload = async (file) => {
        ...
        if (!allowedExtensions.includes(selectedFile?.type)) {
            ...
            formdata.append("ItemId", encodeURIComponent(decryptedItemIdBytes))
    ...
    const imageUpload = () => {
        return (
            <form onSubmit={imageDetailsFormik.handleSubmit}>
                <div className="mb-3">
                    <div>
                        <img width={200} height={200} src={ThumbURLstate !== '' ? ThumbURLstate?.s3Image : resGetItemInfoAPI?.data?.data[0]?.Thumb} />
                    </div>
                    <br />
                ...
                <div className="mb-3">
                    <div>
                        <img width={200} height={200} src={MediaURLstate !== "" ? MediaURLstate?.s3Image : resGetItemInfoAPI?.data?.data[0]?.Media} />
                    </div>
                    <br />
    ...
    useEffect(() => {
        if (resGetItemInfoAPI?.status === "fulfilled") {
            let itemInfoFromAPI = resGetItemInfoAPI?.data?.data[0];
            setcollectionIdState(itemInfoFromAPI?.CollectionId)
            generalInfoFromik.setValues({
                Unique: itemInfoFromAPI?.Unique ? "Unique" : "multiple",
                ProductCategory: itemInfoFromAPI?.ProductCategory,
                ProductName: itemInfoFromAPI?.ProductName,
                ProductBrand: itemInfoFromAPI?.ProductBrand,
                ProductFabric: itemInfoFromAPI?.ProductFabric,
                ProductStyle: itemInfoFromAPI?.ProductStyle,
                ProductSize: itemInfoFromAPI?.ProductSize,
                ProductMaterial: itemInfoFromAPI?.ProductMaterial,
                ProductTechnique: itemInfoFromAPI?.ProductTechnique,
                ProductShape: itemInfoFromAPI?.ProductShape,
                ProductType: itemInfoFromAPI?.ProductType,
                Title: itemInfoFromAPI?.Title,
                CreationYear: itemInfoFromAPI?.CreationYear,
                Publisher: itemInfoFromAPI.Publisher,
                PhysicalEdition: itemInfoFromAPI.PhysicalEdition,
                DigitalEdition: itemInfoFromAPI.DigitalEdition,
                Dimension: itemInfoFromAPI?.Dimension,
                Height: itemInfoFromAPI?.Height,
                Width: itemInfoFromAPI?.Width,
                Depth: itemInfoFromAPI?.Depth,
                CollectionId: itemInfoFromAPI?.CollectionId,
                PhysicalArt: itemInfoFromAPI?.PhysicalArt
            })
            artistDetailsFromik.setValues({
                Figurative: itemInfoFromAPI?.Figurative === "Figurative" ? "Figurative" : "Abstract",
                Series: itemInfoFromAPI?.Series,
                Style: itemInfoFromAPI?.StyleId,
                Subject: itemInfoFromAPI?.SubjectId,
                Keywords: itemInfoFromAPI?.KeywordsId,
                Condition: itemInfoFromAPI?.Condition,
                Signature: itemInfoFromAPI?.Signature,
                Description: itemInfoFromAPI?.Description,
                Artworkid: encodeURIComponent(decryptedItemIdBytes)
            })
            pricingFromik.setValues({
                PriceDisplay: itemInfoFromAPI?.PriceDisplay ? "Display the price" : "Hide the price",
                AutoAcceptOffers: itemInfoFromAPI?.AutoAcceptOffers,
                AutoRejectOffers: itemInfoFromAPI?.AutoRejectOffers,
                PhysicalPrice: itemInfoFromAPI.PhysicalPrice,
                DigitalPrice: itemInfoFromAPI.DigitalPrice,
                PriceTransparency: itemInfoFromAPI?.PriceTransparency,
                Artworkid: encodeURIComponent(decryptedItemIdBytes)
            })
            logisticsFromik.setValues({
                Framed: itemInfoFromAPI?.Framed ? 'framed' : 'unframed',
                Panel: itemInfoFromAPI?.Panel ? "Single" : "multiple",
                Packaging: itemInfoFromAPI?.Packaging,
                PackageDimension: itemInfoFromAPI?.PackageDimension === "IN" ? "IN" : "CM",
                PackageHeight: itemInfoFromAPI?.PackageHeight,
                PackageWidth: itemInfoFromAPI?.PackageWidth,
                PackageDepth: itemInfoFromAPI?.PackageDepth,
                PackageWeight: itemInfoFromAPI?.PackageWeight === "KG" ? "KG" : "LB",
                PackageWeightValue: itemInfoFromAPI?.PackageWeightValue,
                Artworkid: encodeURIComponent(decryptedItemIdBytes)
            })
        }
    }, [resGetItemInfoAPI])
