...
export default function BulkItems(props) {
            ...
            <div className="container">
                <div className="row">
                    <div className="col-12 ">
                        ...
                        <h1 className="bulk-art-title">Create bulk artwork</h1>
                            ...
                            <div className="row">
                                <div className="col-12 col-sm-12 col-lg-6 col-xl-6">
                                    <div className="mb-3 box-div-bulk">
                                        ...
                                        }} type="file" style={{ display: "none" }} className="form-control" ref={fileInputCSVRef} />
                                ...
                                <div className="col-12 col-sm-12 col-lg-6 col-xl-6">
                                    <div className="mb-3 box-div-bulk">
                                        ...
                                        }} type="file" directory="" webkitdirectory="" style={{ display: "none" }} className="form-control" />
                                        {formik.values.Thumb !== '' ?
                                            <>
                                                <br />
                                                <br />
