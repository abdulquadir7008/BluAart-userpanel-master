            ...
            <>
                {resGetItemInfoAPI.isLoading ? <>
                    ...
                    <form onSubmit={generalInfoFromik.handleSubmit}>
                        ...
                        <select className="form-select form-select-lg" name="Category" onChange={generalInfoFromik.handleChange} aria-label=".form-select-lg example">
                            <option ></option>
                            {CategoryAPI.map((style, index) => {
                                return <option selected={generalInfoFromik.values.Category === Number(style?._id)} key={index} value={Number(style?._id)}>{style?.Title}</option>
                            })}
                        </select>
                        ...
                        <div className="mb-3">
                            ...
                            <input name="Publisher" onChange={generalInfoFromik.handleChange} value={generalInfoFromik.values.Publisher} type="text" className="form-control" id="exampleInputName" aria-describedby="emailHelp" />
    ...
    useEffect(() => {
        if (resGetItemInfoAPI?.status === "fulfilled") {
            ...
            generalInfoFromik.setValues({
                ...
                Category: itemInfoFromAPI?.Category,
                Material: itemInfoFromAPI?.MaterialId,
                ...
                Orientation: itemInfoFromAPI?.Orientation,
